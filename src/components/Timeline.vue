<template>
  <div class="mt-24 flex flex-col  bg-no-repeat justify-center justify-center max-w-screen-sm mx-auto " style="background-position: right -60px; background-size: 45% auto; background-image: url(/images/bg-5.svg)" >
