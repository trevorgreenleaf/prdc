  ...
  <div class="max-w-screen-md mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="flex justify-center md:order-2">
      ...
      <a target="_blank" href="https://www.instagram.com/accd.hackathons/" class="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <svg class="h-8 w-8" fill="#000" viewBox="0 0 24 24">
    ...
    <div class="mt-8 md:mt-0 md:order-1">
      <p class="text-center text-base leading-6 text-black">
        ACCD "Hack"athon Club - <a class="text-orange" target="_blank" href="https://www.linkedin.com/in/dillonchi/">Dillon Chi</a> and <a  class="text-orange" target="_blank" href="https://www.linkedin.com/in/susie-moon-53668896/">Susie Moon</a> 
      </p>
    </div>
