<template>
  <div id="speakers" class="mt-24 flex flex-col bg-no-repeat items-center mb-12 justify-center text-center" style="background-position: left 0%; background-size: 85% auto; background-image: url(/images/bg-2.svg)">
	...
	<h2 class="font-bold text-4xl sm:text-5xl md:text-6xl  text-center">Speakers, Mentors, and Judges</h2>
	...
	<div class="flex flex-wrap max-w-screen-md mx-auto">
		...
		<div class="w-1/2 md:w-1/3  flex flex-col items-center mb-12 ">
			<a target="_blank" class="text-center flex flex-col items-center" href="https://www.linkedin.com/in/taraxknight/">
				...
				<p class="font-bold text-xl">Tara Knight<span class=" text-sm block font-normal text-gray-500">Strategic Development Manager, Creative Cloud Design, Adobe</span></p>
			</a>
		</div>
