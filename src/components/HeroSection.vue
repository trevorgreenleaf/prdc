  ...
  <div>
    ...
    <div class="mx-auto px-4 text-center">
        ...
        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center ">
          <div>
            <a href="#" class="w-full flex items-center justify-center px-8 py-3 text-base leading-6 font-bold rounded-full text-white bg-orange hover:bg-orange  md:py-4 md:text-lg md:px-10">
              Sign up
            </a>
          </div>
